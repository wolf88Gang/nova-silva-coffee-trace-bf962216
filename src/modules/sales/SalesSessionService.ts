 ...
 *
 * Auth requirement: caller must be authenticated as a user with a row in
 * admin_panel_roles where role IN ('admin','sales_manager','sales_analyst')
 * and is_active = true. The RPCs enforce this via _ensure_internal().
 *
