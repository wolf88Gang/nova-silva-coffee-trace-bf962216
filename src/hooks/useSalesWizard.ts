 ...
 *
 * Flow: createSession → loop (getNextStep → saveAnswer) until is_complete → finalizeSession.
 * Auth: caller must be admin (RPCs enforce via _ensure_internal).
 * Tenant: organization_id from platform_organizations.
 */
