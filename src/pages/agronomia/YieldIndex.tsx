  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-4">
        {[
          { label: 'Estimaciones activas', value: '15', icon: TrendingUp },
          { label: 'Pendientes de validar', value: '8', icon: Clock },
          { label: 'Completadas (campaña)', value: '42', icon: CheckCircle },
          { label: 'Parcelas sin estimación', value: '23', icon: Map },
        ].map(k => (
          <Card key={k.label}>
      ...
      <Tabs defaultValue="activas">
        ...
        <TabsContent value="pendientes" className="mt-4">
          <Card><CardContent className="pt-5 text-center text-muted-foreground text-sm py-12">Estimaciones pendientes de validación</CardContent></Card>
        </TabsContent>
        <TabsContent value="completadas" className="mt-4">
          <Card><CardContent className="pt-5 text-center text-muted-foreground text-sm py-12">Estimaciones completadas esta campaña</CardContent></Card>
        </TabsContent>
        <TabsContent value="parcelas" className="mt-4">
          <Card><CardContent className="pt-5 text-center text-muted-foreground text-sm py-12">Vista agrupada por parcela</CardContent></Card>
        </TabsContent>
      </Tabs>
    </div>
  );
